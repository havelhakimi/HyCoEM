...
logging.basicConfig(filename=f'./exp/logs/{args.dataset}_b{args.batch_size}_CLwt{args.cl_wt}_temp{args.cl_temp}_N{args.neg_sample}_P{args.pool}_LCT{args.learn_curv}_seed_{args.seed}.log', level=logging.INFO)
